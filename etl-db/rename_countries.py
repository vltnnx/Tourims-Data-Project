...
def rename_countries(*dfs):
    ...
    for df in dfs:
        ...
        df.loc[df["country_name"] == "Congo, The Democratic Republic of the", "country_name"] = "Congo"
        df.loc[df["country_name"] == "Democratic Republic of Congo", "country_name"] = "Congo"
        df.loc[df["country_name"] == "Congo, Democratic Republic of the", "country_name"] = "Congo"
